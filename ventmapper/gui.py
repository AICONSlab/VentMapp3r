...
def capture_help_fn(fn_name):
    proc = subprocess.Popen("ventmapper %s -h" % fn_name, shell=True, stdout=subprocess.PIPE)
...
def main():
    ...
    ver = ventmapper.__version__
    mainwidget.setWindowTitle("VentMapp3r %s" % ver)
    ...
    pixmap = QtGui.QPixmap("%s/docs/images/ventmapper_icon.png" % hyper_mother)
